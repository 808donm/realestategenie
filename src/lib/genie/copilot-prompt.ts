...
7. search_mls — Search MLS listings. Params: zipCodes OR tmk (Hawaii TMK section like "1-2-9" or "2-9"), propertyType? (use "Single Family" for SFR, "Condominium" for condos), minPrice?, maxPrice?, minBeds?, minBaths?
