...
export class GHLDocumentsClient {
  ...
  async upsertContactWithLeaseData(
    ...
    const fieldMappings: Record<string, any> = {
      ...
      lease_late_fee_type_fixed_checkbox: leaseData.late_fee_is_percentage ? '☐' : '☑',
      lease_late_fee_type_percentage_checkbox: leaseData.late_fee_is_percentage ? '☑' : '☐',
      ...
      lease_late_fee_frequency_occurrence_checkbox: (leaseData.late_fee_frequency || 'per occurrence') === 'per occurrence' ? '☑' : '☐',
      lease_late_fee_frequency_daily_checkbox: (leaseData.late_fee_frequency || 'per occurrence') === 'per day' ? '☑' : '☐',
      ...
      lease_subletting_yes_checkbox: leaseData.subletting_allowed ? '☑' : '☐',
      lease_subletting_no_checkbox: leaseData.subletting_allowed ? '☐' : '☑',
      lease_pets_allowed: leaseData.pets_allowed ? 'true' : 'false',
      lease_pets_yes_checkbox: leaseData.pets_allowed ? '☑' : '☐',
      lease_pets_no_checkbox: leaseData.pets_allowed ? '☐' : '☑',
