      ...
      <div className="max-w-4xl mx-auto">
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none">
            ...
            <p>
              The Real Estate Genie ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy
              explains how we collect, use, disclose, and safeguard your information when you use our open house
              management platform.
            </p>
            ...
            <ul>
              <li>
                <strong>Account Information:</strong> Name, email address, phone number, license number, brokerage
                information
              </li>
              <li>
                <strong>Profile Information:</strong> Headshot/logo, bio, locations served, branding preferences
              </li>
              <li>
                <strong>Property Information:</strong> Open house details, property fact sheets, listings
              </li>
              <li>
                <strong>Lead Information:</strong> Visitor contact details, preferences, and responses collected during
                open houses
              </li>
            </ul>
            ...
            <p>With your explicit consent, we may share your data with:</p>
            <ul>
              <li>
                <strong>GoHighLevel:</strong> For CRM and lead management
              </li>
              <li>
                <strong>n8n:</strong> For workflow automation
              </li>
              <li>
                <strong>IDX Broker:</strong> For property listings (if enabled)
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                <strong>Email Service Providers:</strong> For transactional emails
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                <strong>Deletion:</strong> Request deletion of your account and data (see{" "}
            ...
            <p>For leads captured during open houses:</p>
            <ul>
            ...
            <ul>
              ...
              <li>
                <strong>Deleted Accounts:</strong> Data permanently deleted within 30 days of deletion request
              </li>
            </ul>
