    ...
    <div>
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 14, opacity: 0.9 }}>Hawai&apos;i Island Market: {data.headline}</div>
        ...
        {hasMultipleMonths && (
          ...
          >
            {HAWAII_ISLAND_MONTHLY_DATA.map((m) => (
              <option key={m.month} value={m.month} style={{ color: "#064e3b" }}>
                {m.label}
              </option>
            ))}
          </select>
          ...
          <tbody>
            {[
              ...
              { label: "Days on Market", sfVal: `${sf.dom} days`, cdVal: `${cd.dom} days`, ldVal: `${ld.dom} days` },
              {
                ...
                ldVal: ld.activeListings.toLocaleString(),
              },
              {
