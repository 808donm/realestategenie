...
const SAMPLE_DATA: PendingDocument[] = [
  {
    id: "D-001",
    propertyAddress: "1422 Maple Ridge Dr, Austin TX 78745",
    buyerSeller: "James & Linda Carter (Buyer)",
  ...
  {
    id: "D-004",
    propertyAddress: "305 Oakwood Blvd, Round Rock TX 78664",
    buyerSeller: "Maria Gonzalez (Seller)",
    agent: "David Park",
    documentName: "Seller Disclosure Notice",
    status: "Signed",
    dueDate: "2025-01-08",
  },
  {
  ...
  {
    id: "D-007",
    propertyAddress: "789 Elm Crest Ln, Cedar Park TX 78613",
    buyerSeller: "Robert & Anne Nguyen (Buyer)",
    agent: "Sarah Mitchell",
    documentName: "Loan Pre-Approval Letter",
    status: "Signed",
    dueDate: "2025-01-05",
  },
  {
  ...
  },
  {
    ...
    buyerSeller: "Robert & Anne Nguyen (Buyer)",
    agent: "Sarah Mitchell",
    documentName: "HOA Addendum",
    status: "Missing",
    dueDate: "2025-01-14",
  },
  {
    id: "D-010",
    propertyAddress: "1050 Pecan Valley Ct, Pflugerville TX 78660",
    buyerSeller: "Thomas Reeves (Buyer)",
    agent: "Jessica Adams",
  ...
  },
  {
    ...
    buyerSeller: "Thomas Reeves (Buyer)",
    agent: "Jessica Adams",
    documentName: "Option Period Extension",
    status: "Pending",
    dueDate: "2025-01-20",
  },
  {
    ...
    buyerSeller: "Thomas Reeves (Buyer)",
    agent: "Jessica Adams",
    documentName: "Termite Inspection Report",
    status: "Signed",
    dueDate: "2025-01-09",
  },
  {
    id: "D-013",
    propertyAddress: "2200 Riverside Dr #4B, Austin TX 78741",
    buyerSeller: "Samantha Blake (Seller)",
    agent: "David Park",
    documentName: "Listing Agreement",
    status: "Signed",
    dueDate: "2025-01-02",
  },
  {
  ...
  },
  {
    ...
    buyerSeller: "Samantha Blake (Seller)",
    agent: "David Park",
    documentName: "Seller's Property Condition Disclosure",
    status: "Missing",
    dueDate: "2025-01-11",
  },
];
...
export default function PendingDocumentsClient() {
  ...
  const exportToPDF = () => {
    ...
    doc.setFontSize(10);
    doc.setFont("helvetica", "normal");
    doc.text(`Total Documents: ${totalDocs}`, 25, y);
    y += 6;
    doc.text(`Signed/Complete: ${signedCount}`, 25, y);
    y += 6;
    doc.text(`Pending: ${pendingCount}`, 25, y);
    y += 6;
    doc.text(`Missing/Overdue: ${missingCount} (${overdueCount} overdue)`, 25, y);
    y += 12;
        ...
        >
          <div>
            ...
            <span style={{ fontSize: 13, opacity: 0.8, marginLeft: 8 }}>
              Connect GHL to pull real document tracking from your pipeline.
            </span>
          </div>
          <Link
              ...
              {docs.map((d) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: "10px 16px", textAlign: "center" }}>{statusBadge(d.status)}</td>
                    <td
                      style={{
                        padding: "10px 16px",
                        textAlign: "right",
