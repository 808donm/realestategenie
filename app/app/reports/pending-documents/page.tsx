...
import PendingDocumentsClient from "./pending-documents.client";
...
export default function PendingDocumentsPage() {
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto" }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 900, marginTop: 0, marginBottom: 8 }}>Pending Document Checklist</h1>
