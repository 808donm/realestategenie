...
export default function ComplianceAuditPage() {
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto" }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 900, marginTop: 0, marginBottom: 8 }}>Compliance &amp; Audit Log</h1>
      <p style={{ margin: "0 0 24px 0", opacity: 0.7 }}>
        Track every compliance event across your brokerage. Ensure nothing falls through the cracks. Data from GHL +
        App.
      </p>
