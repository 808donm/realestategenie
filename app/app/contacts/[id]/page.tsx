  ...
  if (!isGHLConnected) {
    return (
      <div style={{ padding: 32, background: "#fef3c7", border: "1px solid #f59e0b", borderRadius: 12, textAlign: "center" }}>
        <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 8 }}>LeadConnector Not Connected</h2>
        <p style={{ marginBottom: 16, color: "#92400e" }}>Connect your LeadConnector account to view contact details.</p>
