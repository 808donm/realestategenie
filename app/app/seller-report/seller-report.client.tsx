  ...
  const handleGenerateSellerReport = useCallback(async () => {
    ...
    try {
      ...
      const reportData: any = {
        ...
        fireplaceCount: building.interior?.fplcCount || (bldgFeatures.fireplace === true ? 1 : undefined),
        basementType: (() => { const bt = building.interior?.bsmtType || rRaw.basementType || mlsListing.Basement; return bt && !bt.toLowerCase().includes("no ") && !bt.toLowerCase().includes("none") ? bt : undefined; })(),
