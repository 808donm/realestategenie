    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-3">
          <div className="p-4 border rounded-lg opacity-50 bg-muted/20">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold">RealtyCandy</h3>
            </div>
          ...
          <div className="p-4 border rounded-lg opacity-50 bg-muted/20">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold">IDX Broker</h3>
            </div>
            <p className="text-sm text-muted-foreground mb-3">
          ...
          <div className="p-4 border rounded-lg opacity-50 bg-muted/20">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold">OSI IDX Broker</h3>
            </div>
            <p className="text-sm text-muted-foreground mb-3">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div className="p-4 border rounded-lg opacity-50">
            ...
            <p className="text-sm text-muted-foreground">
              Connect to 5000+ apps and automate workflows
            </p>
          </div>
        </CardContent>
      </Card>
