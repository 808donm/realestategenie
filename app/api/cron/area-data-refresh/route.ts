...
const OAHU_ZIPS = [
  ...
  "96792", "96795", "96797",
  "96801", "96802", "96803", "96804", "96805", "96806", "96807", "96808",
  "96809", "96810", "96811", "96812", "96813", "96814", "96815", "96816",
  "96817", "96818", "96819", "96820", "96821", "96822", "96823", "96824",
  "96825", "96826", "96827", "96828", "96830", "96835", "96836", "96837",
  "96838", "96839", "96840", "96841", "96842", "96843", "96844", "96846",
  "96847", "96848", "96849", "96850", "96853", "96854", "96857", "96858",
  "96859", "96860", "96861", "96862", "96863", "96898",
];
...
export async function POST(request: NextRequest) {
  try {
    ...
    for (let i = 0; i < OAHU_ZIPS.length; i += BATCH_SIZE) {
      ...
      console.log(`[AreaCache] Processing batch ${Math.floor(i / BATCH_SIZE) + 1}/${Math.ceil(OAHU_ZIPS.length / BATCH_SIZE)}: ${batch.join(", ")}`);
    ...
    return NextResponse.json(
      { error: error.message || "Area data refresh failed" },
      { status: 500 }
    );
  }
}
