...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.log(`Payment link email sent successfully to ${accessReq.email}`);
      ...
      return NextResponse.json({
        ...
        checkoutUrl: session.url,
        emailSent: false,
        warning: "Approval successful but email failed to send. Please share the payment link manually.",
