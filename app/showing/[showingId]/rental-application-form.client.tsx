...
export default function RentalApplicationForm({
  ...
  async function submit(e: React.FormEvent) {
    ...
    const r = await fetch("/api/pm/applications/submit-from-showing", {
      method: "POST",
      headers: { "content-type": "application/json" },
      body: JSON.stringify({ showingId, applicationData }),
    });
    ...
    window.location.href = `/showing/${showingId}/thank-you`;
  }
        ...
        <div style={{ padding: 16, border: "1px solid #ddd", borderRadius: 12 }}>
          ...
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <label style={{ display: "flex", gap: 10, alignItems: "start" }}>
              ...
              <span style={{ fontSize: 14 }}>
                I agree to receive SMS messages about this application and property updates.
              </span>
            </label>
