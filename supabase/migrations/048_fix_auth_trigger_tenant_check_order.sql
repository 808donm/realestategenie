-- Fix auth trigger to check role BEFORE accessing agents table
-- The previous version tried to access agents table before checking if user is a tenant
-- This fixes the "relation agents does not exist" error for tenant users
