...
### Seller Report
Cover page with hero photo and agent branding, personal note, valuation summary cards (AVM, CMA value, last sale, equity), AVM range bar, CMA range bar, property facts, building details, interior/exterior features, legal description (parcel, zoning, census tract, legal text), owner facts, multi-year tax history table, estimated equity section with visual equity bar (property value vs loan balance), photo gallery (up to 12), market trends with market type indicator and MoM arrows, sales history table, comparable sales with CMA adjustments (address, status, price, adjusted price), pricing strategy table (for sale/closed/distressed/expired with low/median/high), CMA pricing summary with recommended price in gold box, environmental hazard zones. Generated from property data (public records) via property search.
